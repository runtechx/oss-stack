...
| [`scripts`](/scripts)     | Conjunto de scripts automatizados para instalação, configuração e preparação de software open source em sistemas AlmaLinux 10+.                                                                                       |
| [`stack`](/stack) | Catálogo da stack tecnológica utilizada pela RunTech, incluindo softwares, plataformas, serviços e ferramentas adotadas na construção, gestão, automação e operação da nossa infraestrutura TIC. |                                                                                    |
