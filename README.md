...
| `stack` | Catálogo da stack tecnológica utilizada pela RunTech, incluindo softwares, plataformas, serviços e ferramentas adotadas na construção, gestão, automação e operação da sua infraestrutura TIC. |                                                                                    |
